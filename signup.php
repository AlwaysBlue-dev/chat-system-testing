		...
		<div id="signup_form" class="well">
			...
			<form method="POST" action="register.php">
				...
				?>
					...
					<h1 style="font-size: small; color:#fff">Name:</h1> <input type="text" name="name" class="form-control" value="<?php echo $steamprofile['personaname'] ?>" readonly>
				...
				?>
					<h1 style="font-size: small; color:#fff">Name: </h1><input type="text" name="name" class="form-control" value="Login with steam first" readonly>
					<div style="height: 10px;"></div>
